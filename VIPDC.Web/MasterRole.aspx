<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterRole.aspx.cs" Inherits="VIPDC.Web.MasterRole" StylesheetTheme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">            
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" CellSpacing="0" DataSourceID="sdsMaster" GridLines="None" ShowGroupPanel="True" AutoGenerateColumns="False" OnItemCommand="RadGrid1_ItemCommand" GroupingSettings-CaseSensitive="false" OnItemDataBound="RadGrid1_ItemDataBound">
                ...
                <MasterTableView DataKeyNames="ID" DataSourceID="sdsMaster">                    
                    <Columns>
                        ...
                        <telerik:GridHyperLinkColumn DataNavigateUrlFields="ID" DataNavigateUrlFormatString="ManageRolePrivilege.aspx?RoleID={0}" ImageUrl="Images/hand.png" AllowFiltering="false" ItemStyle-Width="20px">                            
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" ConnectionString="<%$ ConnectionStrings:VIPDCConnectionString %>" SelectCommand="proc_GetAllRoles" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </asp:View>
