<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="ReportListConfirmationLetter.aspx.cs" Inherits="VIPDC.Web.ReportListConfirmationLetter" StyleSheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <script>
        function ShowReport() {
            ...
            showSimplePopUp('ReportPreview.aspx?ReportName=ListConfirmationLetter&FromDate=' + fromDate.get_selectedDate().format("yyyy-MM-dd") + '&ToDate=' + toDate.get_selectedDate().format("yyyy-MM-dd"));
            return false;
        }
    </script>
</asp:Content>
