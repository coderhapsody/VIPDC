<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterJobPosition.aspx.cs" Inherits="VIPDC.Web.MasterJobPosition" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" ConnectionString="<%$ ConnectionStrings:VIPDCConnectionString %>" SelectCommand="proc_GetAllJobPosition" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
