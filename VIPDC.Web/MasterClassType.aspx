<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterClassType.aspx.cs" Inherits="VIPDC.Web.MasterClassType" StylesheetTheme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" CellSpacing="0" DataSourceID="sdsMaster" GridLines="None" ShowGroupPanel="True" AutoGenerateColumns="False" OnItemCommand="RadGrid1_ItemCommand" GroupingSettings-CaseSensitive="false">
                ...
                <MasterTableView DataKeyNames="ID" DataSourceID="sdsMaster">                    
                    <Columns>
                        ...
                        <telerik:GridCheckBoxColumn DataField="Tax" DataType="System.Boolean" FilterControlAltText="Filter Tax column" HeaderText="Tax" SortExpression="Tax" UniqueName="Tax">
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" ConnectionString="<%$ ConnectionStrings:VIPDCConnectionString %>" SelectCommand="proc_GetAllClassTypes" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
        ...
        <asp:View runat="server" ID="viwAddEdit">
            ...
            <table class="noborder fullwidth">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <asp:CheckBox runat="server" ID="chkTax"></asp:CheckBox>
                    </td>
                </tr>
                <tr>
                    <td></td>
